                                ...
                                <form class="cons-contact-form" method="post" action="form-handler.php">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            <button name="submit" type="submit" value="Submit" class="site-button-secondry  m-r15">Envoyer </button>
                                            <button name="Resat" type="reset" value="Reset" class="site-button ">Renitialiser</button>
                                        </div>
